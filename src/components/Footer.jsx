...
const Footer = () => {
  return (
    <div className=' w-full h-screen bg-zinc-100 text-zinc-800 flex'>
      <div className="w-1/2 flex flex-col p-20 justify-between h-full ']">
        <div className='text-[9vw] font-semibold uppercase font-["Founders_Grotesk_X-Condensed"]'>
          {" "}
          <h1>Eye -</h1>
          <h1 className='-my-32'>Opening</h1>
        </div>
        <svg
          width='72'
          height='30'
      ...
      <div className="w-1/2 h-full py-20 flex flex-col gap-10 ">
        <h1 className="text-[9vw] font-semibold uppercase font-['Founders_Grotesk_X-Condensed']">Presentations</h1>
        <div className="dets flex-col flex text-2xl font-['Neue_Montreal']">
            <h1>S.</h1>
        ...
        <div className="dets text-2xl font-['Neue_Montreal']">
            <h1>S.</h1>
